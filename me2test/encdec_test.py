...
class EncoderTest(unittest.TestCase):
  ...
  def test_encode_ally_loyalty(self):
    ...
    self.assertEqual(self.encoder.get_result(), 0x006c00)
  ...
  def test_encode_squad(self):
    ...
    self.assertEqual(self.encoder.get_result(), 0xd2a1)
  ...
  def test_encode_choices(self):
    ...
    self.assertEqual(self.encoder.get_result(), 0x4b2bc0e01)
